...
class Nertz_Form_Field_File extends Nertz_Form_Field
{
	function Nertz_Form_Field_File($name, &$form)
	{
	...
	function check()
	{
		...
		if ($_FILES[$name]['error'] ==  UPLOAD_ERR_NO_FILE && $this->params['reqired']) {
